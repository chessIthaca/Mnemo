+++
title = "Message/ToolCall construction via typed constructors — MERGED into main (508997a)"
supersedes = "2026-12-20-message-toolcall-construction-via-typed-construc"
created = "2026-12-21"
+++

MERGED into main at 508997a on 2026-12-21 (merge_to_main skill), branch wt/agenticcoding deleted (pre-merge tip 415e8b8). DECISION: Message/ToolCall construction via typed constructors (plan ff17566f, commits d6a3995 + 6d66bd8 on wt/agenticcoding, now in main). Use constructors not struct literals.
