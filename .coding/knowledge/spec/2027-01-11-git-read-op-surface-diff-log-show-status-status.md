...
Tests: status_op_lists_dirty_tree_and_summarizes + status_op_reports_clean_tree + the tightened unknown_or_missing_op_errors_with_the_valid_set (src/tool/agent/git_read_tool.rs). Known stale (pre-unification, future doc pass): agent.md:124 and the SPEC record 2026-08-23-strict-reviewer-surface-failed-reviewer-protocol.md still name git_diff/git_log/git_show.
